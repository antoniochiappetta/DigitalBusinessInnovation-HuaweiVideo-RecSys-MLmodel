...
class Movielens20MColdReader(DataReader):

    DATASET_SUBFOLDER = "MMTF14K/Final_MMTF24K_Web/Data/itemids_splitted_5foldCV"

    IS_IMPLICIT = True


    def __init__(self):
        super(Movielens20MColdReader, self).__init__()
    ...
    def _load_from_original_file(self):
        ...
        print("Movielens20MColdReader: Loading original data")
